...
Используется для сглаживания ратеризованых линий. Работает по принципу: чем ближе пиксель к реальной линии тем он ярче

## Алгоритм Кастла Питвея

Работает по приципу построения изначального паттерна, т.к. по факту рисование растеризованной линии сводиться к пошаговому переходу от прямого рисования к диагональному
